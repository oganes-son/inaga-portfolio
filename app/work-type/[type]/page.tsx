...
export default function WorksList() {
  ...
  /* 🟢 タイトルを MUSIC または DESIGN に変更 */
  const title = type === 'music' ? 'MUSIC' : 'DESIGN';
    ...
    <div className="min-h-screen bg-[#ffffff] text-[#333333] pt-20 pb-32 px-4 md:px-10">
      <div className="max-w-6xl mx-auto">
        <header className="mb-16 md:mb-24 text-left">
          <a href="/#works" className="inline-flex items-center gap-2 font-['Bahnschrift'] text-[10pt] opacity-50 hover:opacity-100 transition-opacity mb-8 tracking-widest">
            <FaArrowLeft /> BACK TO TOP
          </a>
          {/* 🟢 タイトルの文字間隔を調整 */}
          <h1 className="text-[24pt] md:text-[32pt] font-['Bahnschrift'] tracking-wider">
            {title}
          </h1>
        </header>
