  ...
  return (
    ...
    >
      <motion.div className="flex items-center gap-6" variants={{ initial: { scale: 1 }, hover: { scale: 1.05 } }} transition={{ duration: 0.2 }}>
        {/* ↓ アイコンのサイズも一回り小さく調整 (20/24pt → 16/20pt) */}
        ...
        <AnimatePresence>
          {isOpen && (
            ...
            >
              ...
              <div className="flex gap-8 text-[28px] mt-16 text-[#333333]">
                  ...
                  <span className="text-[11pt]">
                    {item.link ? (
                      <a 
                        ...
                        className="hover:opacity-50 underline underline-offset-4 transition-opacity"
                      >
                        {item.content}
                      </a>
                    ) : (
